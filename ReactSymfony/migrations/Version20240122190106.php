 ...
 */
final class Version20240122190106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bloc (id INT AUTO_INCREMENT NOT NULL, articles_id INT NOT NULL, bloc_type VARCHAR(255) NOT NULL, title LONGTEXT DEFAULT NULL, text LONGTEXT DEFAULT NULL, created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', article_id INT NOT NULL, image_path VARCHAR(255) DEFAULT NULL, graph_type VARCHAR(255) DEFAULT NULL, graph_path VARCHAR(255) DEFAULT NULL, INDEX IDX_C778955A1EBAF6CC (articles_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
